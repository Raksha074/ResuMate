		...
		<div className="max-w-4xl mx-auto bg-white text-gray-800">
			...
			<header className="p-8 text-white" style={{ backgroundColor: accentColor }}>
				...
				{data.personal_info?.profession && (
					<h2 className="text-xl mb-4 font-medium opacity-90">
						{data.personal_info.profession}
					</h2>
				)}
								...
								{data.projects.map((project, index) => (
									<div key={index}>
										<div className="flex justify-between items-baseline mb-1">
											<h3 className="font-semibold text-gray-900">
												{project.title} {project.type && <span className="text-gray-500 font-normal ml-1">| {project.type}</span>}
											</h3>
                                            {project.link && (
                                                <a href={project.link} target="_blank" rel="noopener noreferrer" className="text-sm font-medium hover:underline flex items-center gap-1" style={{ color: accentColor }}>
